...
<div id="biography" class="row">
    ...
    <table class="span12 table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr data-id="{{ item['id'] }}">
                ...
                <td>{{ item['date'] }}</td>
                <td>
                    <a href="{{ app.request.baseUrl }}/admin/biography/update/{{ item['id'] }}" class="btn btn-inverse">
                        Modifica
                    </a>
                </td>
                <td>
    ...
    <div class="span12 pagination">
        ...
        <a href="{{ app.request.baseUrl }}/admin/biography/insert" class="btn btn-large btn-success" >
            Aggiungi Biografia
        </a>
    </div>
</div>
...
<script>
    var tableViewModel = function() {
        ...
        self.deleteItem = function() {
            var url = '/biography/delete/' + self.id();
