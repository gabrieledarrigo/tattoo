...
<div class="row">
    <div data-bind="with: panel" class="span12">
        <div data-bind="visible: statusMessageIsVisible, css: statuMessageClass">
            ...
            <br/>
            <a href="/admin/biography" class="btn btn-large success">
                Torna all'elenco biografie
            </a>
        </div>
    </div>
    ...
    <div class="span6" data-bind="with: panel">
        ...
        <form id="form-biography" enctype="multipart/form-data" method="post" 
            ...
            <input type="submit" value="Aggiungi Biografia" class="btn btn-large btn-success"/>
        </form>
    </div>
...
<div class="row">
    <div class="span12">
        <a href="/admin/biography" class="btn btn-large btn-warning pull-right">
            Torna all'elenco
        </a>
    </div>
</div>
