...
/**
 * Sketch Controller.
 * Handle all request about sketch entities.
...
class SketchController {
    ...
    public function getItem(Request $request) {
        ...
        $results = $this->modelSketch->getById($id);
    ...
    public function insertItem(Request $request) {
        ...
        if (isset($files)) {
            ...
            for ($i = 0; $i < count($files); $i++) {
                ...
                $insert[] = $this->modelSketch->insert($params);
            }
        }
    ...
    public function updateItem(Request $request) {
        ...
        $result = $this->modelSketch->update($params['id'], $params);
    ...
    public function deleteItem(Request $request) {
        ...
        $result = $this->modelSketch->delete($id);
